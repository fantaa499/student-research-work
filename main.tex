...
\input{inc/0-intro_Anton} % Введение
%\input{inc/0-intro_Oleg} % Введение

\input{inc/1-approach_analysis_Anton} % Анализ подходов к созданию автономных робототехнических систем
%\input{inc/1-approach_analysis_Oleg} % Анализ подходов к созданию автономных робототехнических систем

\input{inc/2-RL_methods} % Анализ методов обучения с подкреплением
